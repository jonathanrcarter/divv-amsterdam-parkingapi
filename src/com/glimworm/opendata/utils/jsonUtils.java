package com.glimworm.opendata.utils;
...
public class jsonUtils {
	...
	public static String getString(org.json.JSONObject OBJ, String KEY, String DEF) {
		...
		try {
			...
			//gwUtils.warning("", className, "getString", "json error getting KEY AS STRING ["+KEY+"]", true);
			retval = DEF;
		}
		return retval;
	}
	...
	public static int getInt(org.json.JSONObject OBJ, String KEY, int DEF) {
		...
		try {
			...
			//gwUtils.warning("", className, "getString", "json error getting KEY AS INT["+KEY+"]", true);
			retval = DEF;
		}
		return retval;
	}
